...
logo='''
 	    ...
 	    '''+end
logo_2='''\x1b[93m         --------------------------------------\n\x1b[96m		     **ARU BOMBER**  \n\x1b[1;32m	          Author  :     ARU \n\x1b[91m             	  Facebook: 	Aru.Ofc \n\x1b[1;32m	          Github  :     Aru-Ofc-Git \n\x1b[1;93m         --------------------------------------
'''
def logoprint(aru):
    for word in aru + '\n':
...
if inp_option==1:
	...
	for i in range(amount):
		...
		if status_ikra == 200 or status_shopup==200 or status_cinespot==200 or status_binge ==200 or status_arogga==200 or status_swap==200 or status_nescho==200 or status_webaccess==200 or status_osudpatra==200 or status_ajkerdeal==200 or status_khaodao==200 or status_un==200 or status_dhb==200:
						i+=1
